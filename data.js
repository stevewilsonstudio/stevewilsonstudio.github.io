...
// Global price visibility (toggleable)
(function () {
  const params = new URLSearchParams(window.location.search);
  const qp = params.get("prices"); // ?prices=0 or ?prices=1

  // default true, but allow saved preference
  const saved = localStorage.getItem("showPrices");
  let show = saved === null ? true : saved === "true";

  if (qp === "0") show = false;
  if (qp === "1") show = true;

  window.SHOW_PRICES = show;

  window.togglePrices = function togglePrices() {
    window.SHOW_PRICES = !window.SHOW_PRICES;
    localStorage.setItem("showPrices", String(window.SHOW_PRICES));
    // refresh page to re-render
    window.location.reload();
  };
})();

// Paintings data (order here controls prev/next order)
window.PAINTINGS = [
  { file: "Beach-Entry.jpg", slug: "beach-entry", title: "Beach Entry", size: '16×20', medium: "acrylic on canvas", status: "available", price: 960 },
  { file: "Breakers.jpg", slug: "breakers", title: "Breakers", size: '30×40', medium: "acrylic on canvas", status: "available", price: 3600 },
  { file: "Breckenridge.jpg", slug: "breckenridge", title: "Breckenridge", size: '16×20', medium: "oil on canvas", status: "available", price: 960 },
  ...
  { file: "Cumberland.jpg", slug: "cumberland", title: "Cumberland", size: '24×36', medium: "oil on canvas", status: "available", price: 5000 },
  ...
  { file: "Keeneland.jpg", slug: "morning-workout", title: "Morning Workout", size: '16×20', medium: "acrylic on cradled birch", status: "available", price: 960 },
  ...
  { file: "Sailboats.jpg", slug: "docks-at-st-simons", title: "Docks at St. Simons", size: '16×20', medium: "acrylic on canvas", status: "available", price: 960 },
  ...
  // If you uploaded Bald-Head-Island.jpg, this will work. If not, upload it or remove this entry.
  { file: "Bald-Head-Island.jpg", slug: "bald-head-island", title: "Bald Head Island", size: '16×20', medium: "acrylic on birch panel", status: "available", price: 960 },
];
